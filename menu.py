...
def menu():
    while True:
        ...
        choice = Prompt.ask('\nChoose a task: (Enter the number)', choices=["1", "2", "3", '4', '5'], default='5')
...
def help_menu():
    ...
    crypto_bot = Prompt.ask('Choose [bold purple]info, commands[/bold purple] (Enter the option number)', choices=["info", "commands"], default='1')
...
def about_us():
    while True:
        ...
        if choice == '1':
            show_bio("Andrew Carroll", "Storytelling, Magic, Software Dev", '''
                __
               / _\ #
               \c /  #
               / \___ #
...
\n^^^^^"""^^^^^^""^^^^^^^^^^
            ...
            show_bio("Slava Makeev", "Outdoors, Adventure, Software Dev", """
     ; 
     ;;
     ;';.
     ;  ;;
...
`;;;;'     """, "https://github.com/S-Makeev")
            ...
            show_bio("Jared Cicarrello", "Software Dev, Marine, Civil Service", """
                          \ : /
                        '-: __ :-'
                        -:  _ :--
                          ,==.
   ...
   \ \      | | |       | \  J
    ...
    _;-r-<_.| \=\    __.;  _/
      {_}"  L-'  '--'   / /|
        ...
        C;.---..'   >%,(   "'
                   /%% /
                  Cccc' """, "https://github.com/JaredCiccarello")
